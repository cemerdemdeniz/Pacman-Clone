...
public class PacMan : MonoBehaviour
{
    ...
    void CheckInput()
    {
        //Movement input depend on keycode
...

    {
        if (targetNode != currentNode && targetNode != null)
        {
            ...
            else { transform.localPosition += (Vector3)direction * _speed * Time.deltaTime; }
        }
    ...
    //Pacman direction depending on orientation   
    ...
    {
        //if pacman will see wall , or vector == (0,0) animation will stop
